...
public class Menu {
    ...
    public void ImprimirMenuDesayunos() {
        ...
        System.out.println("2.-Huevo estrellados \t 10 \t\t $30");
        ...
        System.out.println("7.- Desayuno Americano(Huevo,cafe)\t\t\t 30 \t\t 40");
